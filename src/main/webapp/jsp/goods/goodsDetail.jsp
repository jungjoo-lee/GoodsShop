				...
				<form method="post" name="goodsform">
					...
					<div>
						...
						<div>
							...
							<div>
								수량 : <input id="input_quantity" name="input_quantity"
						...
						<div>
							<div>
								<input type="button" id="add_cart" value="장바구니에 추가">
								<input type="button" id="add_wishlist" value="찜하기">
								<input type="button" id="purchase_now" value="바로 주문하기">
								<input type="button" id="go_main" value="go main"
									onclick="location.href='gshop.do?command=index'">
							</div>
						</div>
